# -*- coding: utf-8 -*-
"""Explore the BBC News archive.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1N-NJ0fn5n4dQPEi5of7BGjvdH6NM0M4D
...
def fit_tokenizer(sentences):
    """
    Fits a Tokenizer on the given sentences

    Args:
        sentences (list of string): list of sentences to fit the tokenizer on
